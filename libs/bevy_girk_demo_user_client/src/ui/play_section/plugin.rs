...
{
let style = &*ui.get::<BasicText>().unwrap();
tracing::error!(?style, "play section");
    ...
    ui.div(|ui| add_play_button(ui, &play_button_area, &play_overlay));
